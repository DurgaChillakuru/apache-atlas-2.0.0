...
COPY atlas_config.py ${ATLAS_HOME}/bin/atlas_config.py
...
CMD ["/bin/bash", "-c", "/home/apache-atlas-2.0.0/apache-atlas-2.0.0/bin/atlas_start.py; tail -fF /home/apache-atlas-2.0.0/apache-atlas-2.0.0/logs/application.log"]
